...
typedef std::basic_string<wchar_t, std::char_traits<wchar_t>, MyAllocator<wchar_t> > n_wstring;
typedef std::basic_string<char, std::char_traits<char>, MyAllocator<char> > n_string;